package ai.megaworks.spring_boot_template.board.domain.posts;
...
import ai.megaworks.spring_boot_template.board.domain.board.QBoard;
import ai.megaworks.spring_boot_template.board.domain.comment.QComment;
import ai.megaworks.spring_boot_template.board.domain.user.QUser;
