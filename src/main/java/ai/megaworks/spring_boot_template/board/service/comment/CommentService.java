package ai.megaworks.spring_boot_template.board.service.comment;

import ai.megaworks.spring_boot_template.common.exception.BusinessMessageException;
import ai.megaworks.spring_boot_template.common.exception.InvalidValueException;
import ai.megaworks.spring_boot_template.common.service.AbstractService;
import lombok.RequiredArgsConstructor;
import ai.megaworks.spring_boot_template.board.api.comment.dto.CommentListResponseDto;
import ai.megaworks.spring_boot_template.board.api.comment.dto.CommentResponseDto;
import ai.megaworks.spring_boot_template.board.api.comment.dto.CommentSaveRequestDto;
import ai.megaworks.spring_boot_template.board.api.comment.dto.CommentUpdateRequestDto;
import ai.megaworks.spring_boot_template.board.domain.board.Board;
import ai.megaworks.spring_boot_template.board.domain.comment.Comment;
import ai.megaworks.spring_boot_template.board.domain.comment.CommentId;
import ai.megaworks.spring_boot_template.board.domain.comment.CommentRepository;
import ai.megaworks.spring_boot_template.board.domain.posts.Posts;
import ai.megaworks.spring_boot_template.board.domain.posts.PostsId;
import ai.megaworks.spring_boot_template.board.service.posts.PostsService;
