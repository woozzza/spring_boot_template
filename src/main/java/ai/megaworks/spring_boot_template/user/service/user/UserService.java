package ai.megaworks.spring_boot_template.user.service.user;

import ai.megaworks.spring_boot_template.user.api.user.dto.UserListResponseDto;
import ai.megaworks.spring_boot_template.user.api.user.dto.UserResponseDto;
import ai.megaworks.spring_boot_template.user.api.user.dto.UserSaveRequestDto;
import ai.megaworks.spring_boot_template.user.api.user.dto.UserUpdateRequestDto;
import ai.megaworks.spring_boot_template.common.domain.Role;
import ai.megaworks.spring_boot_template.common.dto.RequestDto;
import ai.megaworks.spring_boot_template.common.exception.BusinessException;
import ai.megaworks.spring_boot_template.common.exception.BusinessMessageException;
import ai.megaworks.spring_boot_template.common.exception.dto.ErrorCode;
import ai.megaworks.spring_boot_template.common.service.AbstractService;
import ai.megaworks.spring_boot_template.common.util.LogUtil;
import ai.megaworks.spring_boot_template.user.domain.log.LoginLogRepository;
import ai.megaworks.spring_boot_template.user.domain.user.*;
import ai.megaworks.spring_boot_template.user.api.user.dto.*;
...
import ai.megaworks.spring_boot_template.user.config.UserPasswordChangeEmailTemplate;
import ai.megaworks.spring_boot_template.user.config.dto.SocialUser;
import ai.megaworks.spring_boot_template.user.domain.log.LoginLog;
import ai.megaworks.spring_boot_template.user.api.user.dto.SocialUserResponseDto;
