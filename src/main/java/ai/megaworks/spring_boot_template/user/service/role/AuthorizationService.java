package ai.megaworks.spring_boot_template.user.service.role;

import ai.megaworks.spring_boot_template.user.api.role.dto.AuthorizationListResponseDto;
import ai.megaworks.spring_boot_template.user.api.role.dto.AuthorizationResponseDto;
import ai.megaworks.spring_boot_template.user.api.role.dto.AuthorizationSaveRequestDto;
import ai.megaworks.spring_boot_template.user.api.role.dto.AuthorizationUpdateRequestDto;
...
import ai.megaworks.spring_boot_template.user.domain.role.Authorization;
import ai.megaworks.spring_boot_template.user.domain.role.AuthorizationRepository;
...
public class AuthorizationService extends AbstractService {
    ...
    public Boolean isAuthorization(HttpServletRequest request, Authentication authentication) {
        ...
        return isContainMatch(authorizationList, request.getMethod(), request.getRequestURI());
    }
