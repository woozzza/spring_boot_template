package ai.megaworks.spring_boot_template.user.api.user;
...
import ai.megaworks.spring_boot_template.user.domain.user.User;
import ai.megaworks.spring_boot_template.user.domain.user.UserRepository;
import ai.megaworks.spring_boot_template.user.domain.user.UserStateCode;
